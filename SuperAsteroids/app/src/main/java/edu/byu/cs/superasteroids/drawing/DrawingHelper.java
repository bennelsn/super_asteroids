...
public class DrawingHelper {
	...
	public static int getGameViewWidth() {
        ...
        if(vp.isFirstTimeW())
        {
           // vp.setDeviceScreenWidth((float) viewWidth);
            //vp.setDeviceScreenWidth(1080);
            vp.setFirstTimeW(false);
        }
	...
	public static int getGameViewHeight() {
        ...
        if(vp.isFirstTimeH())
        {
            //vp.setDeviceScreenHeight((float) viewHeight);
            //vp.setDeviceScreenHeight(377);
            vp.setFirstTimeH(false);
        }

        return viewHeight;
	}

    public static void setViewWidth(int w) {viewWidth = w;
    }
